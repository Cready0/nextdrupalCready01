...
class __TwigTemplate_93ca34e0ff1d48850bd825df2382a909 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "C:\\drupal\\drupal\\web\\core\\themes\\olivero\\templates\\filter\\filter-tips.html.twig");
    }
